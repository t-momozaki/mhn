# Density function for the Modified Half-Normal distribution.
# Thin wrapper around .dmhn_cpp (src/mhn_dmhn.cpp).
...
#'   \quad (x > 0)}
#' where \eqn{\Psi[a, z]} is the Fox-Wright Psi function
...
#' \itemize{
#'   \item \eqn{\gamma = 0}: sqrt-Gamma distribution
